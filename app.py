...
class SmartCrowdManagementSystem:
    ...
    def update_dashboard_data(self, people_count, alert_triggered):
        ...
        # Update people history (keep last 2000 entries)
        self.people_history.append(people_count)
        if len(self.people_history) > 2000:
            self.people_history = self.people_history[-2000:]
        ...
        # Rate limit saving to JSON (max 1x per second)
    ...
    def create_heatmap(self, frame, people_centers):
        ...
        density_map = cv2.GaussianBlur(density_map, (0, 0), sigmaX=25, sigmaY=25)
...
if __name__ == "__main__":
    ...
    video_path = r"E:\sem4\DAV\project\AI-BASED-CROWD-MANAGEMENT-SYSTEM\pexels_videos_1677252 (2160p).mp4"
